...
<head>
    ...
    <title>Add Author — {{ config('app.name', 'Laravel') }}</title>
...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center justify-center min-h-screen flex-col">
    ...
    <div class="w-full max-w-xl">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Add New Author</h1>
            <p class="mt-1 text-sm text-[#706f6c] dark:text-[#A1A09A]">Fill in the details below to create a new author.</p>
        </div>
